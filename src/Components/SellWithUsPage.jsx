  ...
  return (
    <section className="w-full bg-[#eef2f7] pt-16 flex flex-col lg:flex-row items-center justify-between pl-6 lg:pl-16  gap-8">
      <div className="flex flex-col gap-6 max-w-xl">
        <h1 className="font-bold text-gray-800 text-5xl leading-tight">
...
function WhyChoose() {
  const features = [
    { icon: <FaBox className="text-blue-500 text-xl" />, bg: "bg-blue-100", title: "Smooth shipping across India", desc: "All products are delivered directly to your buyers anywhere in India. We take care of logistics so you can focus on business." },
    { icon: <FaTruck className="text-green-500 text-xl" />, bg: "bg-green-100", title: "On time delivery", desc: "We value your business timelines. Every bulk order is delivered within 20, 60, or 90 days, exactly as promised." },
    { icon: <FaUsers className="text-purple-400 text-xl" />, bg: "bg-gray-200", title: "Nationwide reach", desc: "Reach millions of buyers nationwide. From metro cities to small towns, your products can be discovered everywhere in India." },
  ];

  return (
    <section className="w-full bg-white px-6 lg:px-16 py-5">
      <h2 className="text-center text-3xl font-bold text-gray-700 mb-3">
        Why choose <span className="text-[#1a1456]">Supermargins?</span>
      </h2>
      <p className="flex justify-center text-center text-gray-500 text-lg mx-auto mb-10">
...
function CategoriesWeBuy() {
  ...
  return (
    <section className="w-full bg-white px-6 lg:px-16 py-5">
      <h2 className="text-center text-3xl font-bold text-gray-500 mb-2">
      ...
      <div className="grid grid-cols-2 md:grid-cols-6 gap-3 my-8">
        {cats.map((cat) => (
          <div key={cat} className="border border-black-200 rounded-md px-2 py-2 text-center text-bold  text-lg text-black cursor-pointer hover:border-[#1a1456] hover:text-[#1a1456] transition-colors">
            {cat}
          </div>
        ))}
      </div>
      <div className="flex justify-center">
        <button className="flex items-center gap-2 border border-gray-300 text-gray-700 px-8 py-3 rounded-md text-sm font-medium hover:bg-gray-50">
...
function HowItWorks() {
  const steps = [
    { step: "Step 1", icon: <FaUser className="text-blue-500 text-xl" />, bg: "bg-blue-100", title: "Register in 2 minutes", desc: "Quick and easy registration process" },
    { step: "Step 2", icon: <FaBox className="text-green-500 text-xl" />, bg: "bg-green-100", title: "Upload your products", desc: "Use our automated cataloguing tools" },
    { step: "Step 3", icon: <FaBolt className="text-purple-500 text-xl" />, bg: "bg-purple-100", title: "Receive bulk orders", desc: "Get orders for production" },
    { step: "Step 4", icon: <FaTruck className="text-orange-400 text-xl" />, bg: "bg-orange-100", title: "Fulfill orders", desc: "30,60 & 90 days delivery" },
    { step: "Step 5", icon: <FaCheckCircle className="text-red-400 text-xl" />, bg: "bg-red-100", title: "Get paid instantly", desc: "Through our automated payment system" },
    { step: "Step 6", icon: <FaShareAlt className="text-purple-400 text-xl" />, bg: "bg-purple-100", title: "Scale nationwide", desc: "Sell your products & brands to all over India" },
  ];
        ...
        {steps.map((s) => (
          <div key={s.step} className="bg-white rounded-md p-6 flex flex-col gap-3">
            <div className="flex items-center gap-3">
              ...
              <span className="border border-gray-100 bg-gray-100 text-zinc-950 text-xs px-3 py-1 rounded-xl">{s.step}</span>
            </div>
