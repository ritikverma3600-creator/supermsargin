  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50" onClick={onClose}>
      <div className="bg-white rounded-xl shadow-2xl w-[680px] max-w-[95vw] flex overflow-hidden relative" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="absolute top-0 right-0 bg-[#1a1456] text-white text-[10px] px-3 py-4 rounded-bl-xl font-medium" style={{ writingMode: "vertical-rl", transform: "rotate(180deg)" }}>
          powered by Calendly
        </div>
