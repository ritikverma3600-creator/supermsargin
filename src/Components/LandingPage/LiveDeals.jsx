  ...
  return (
    <section className="w-full  px-12 lg:px-12 py-12">
      ...
      <div className="flex justify-center mb-4">
        <span className="flex items-center gap-2 bg-red-500 text-white px-5 py-2 rounded-full text-[14px] font-medium">
          <FaTag />
          Live Deals
        </span>
      </div>
      ...
      {/* SUBTITLE */}
      <p className="text-center text-gray-500 text-[16px]  mx-auto mb-11">
      ...
      <div className="flex justify-center items-center gap-2 bg-white rounded-lg px-4 py-3 mt-5 overflow-x-auto mb-8  w-fit mx-auto">
        {categories.map((cat) => (
          <button
            ...
            className={`whitespace-nowrap px-5 py-3 rounded-md text-[14px] font-medium transition-colors ${
              activeCategory === cat
        ...
        {products.map((product) => (
          <div key={product.id} className="bg-white rounded-xl overflow-hidden shadow-sm">
            <div className="relative">
              ...
              <span className="absolute top-3 left-3 bg-red-500 text-white text-[12px] font-medium px-3 py-1 rounded-full">
                Wholesale
              </span>
            </div>
            <div className="p-4 flex flex-col gap-2">
              ...
              <button className="mt-2 bg-[#1a1456] text-white py-2 rounded-md text-[14px] font-medium hover:bg-[#2a2466] cursor-pointer">
                Shop Now
              </button>
            </div>
          </div>
