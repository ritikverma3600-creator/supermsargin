  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center px-4">
      <div className="bg-white rounded-xl w-full max-w-md p-8 relative">
        ...
        <button onClick={onClose} className="cursor-pointer absolute top-4 right-4 text-red-500 text-[20px]">
          <FaTimes />
        </button>
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-500 text-[14px] pt-5">Welcome back! Please sign in to your account</p>
        </div>

        {/* ERROR */}
        {error && (
          <div className="bg-red-50 border border-red-200 text-red-600 text-[14px] px-4 py-2 rounded-md mb-4">
            {error}
          </div>
        )}
        ...
        <div className="flex flex-col gap-1 mb-2">
          ...
          <div className="flex items-center border border-gray-300 rounded-md px-3 h-12">
            ...
            <button onClick={() => setShowPassword(!showPassword)}>
              {showPassword ? <FaEye className="cursor-pointer text-gray-400" /> : <FaEyeSlash className="cursor-pointer text-gray-400" />}
            </button>
          </div>
        </div>
        ...
        <button
          onClick={handleLogin}
          className="cursor-pointer w-full bg-[#1a1456] text-white py-3 rounded-md font-semibold hover:bg-[#2a2466] mb-4"
        >
          Login
        </button>
        ...
        <button
          ...
          className="cursor-pointer w-full bg-gray-100 text-gray-800 py-3 rounded-md font-medium hover:bg-gray-200 mb-4"
        >
          Create Account
        </button>
