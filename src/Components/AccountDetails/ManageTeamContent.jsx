...
function ManageTeamContent() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <h2 className="font-bold text-[#1a1456] text-2xl">Add & Manage Team Member</h2>
      ...
      <div className="border border-gray-200 rounded-lg p-5 flex items-center gap-3 cursor-pointer hover:bg-gray-50">
        ...
        <span className="text-[#1a1456] font-medium text-lg">Add New Member</span>
      </div>

      {/* CURRENT MEMBERS */}
      <div>
        <h3 className="font-bold text-[#1a1456] text-lg mb-4">Currents Team Member</h3>
