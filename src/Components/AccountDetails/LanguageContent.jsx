...
function LanguageContent() {
  ...
  return (
    <div className="flex flex-col gap-4">
      <div>
        <h2 className="font-bold text-[#1a1456] text-2xl">Select Language</h2>
        <p className="text-gray-500 text-sm mt-1">Select The Language You Prefer For Browsing, Shopping</p>
      </div>
