          ...
          <thead>
            <tr className="border-b border-gray-200">
              ...
              <th className="text-left px-4 py-3 text-gray-700 font-bold">
                <div className="flex items-center gap-1">Unique ID <span className="text-gray-400 text-xs">⇅</span></div>
              </th>
              ...
              <th className="text-left px-4 py-3 text-gray-700 font-bold">
                <div className="flex items-center gap-1">Price Per Unit <span className="text-gray-400 text-xs">⇅</span></div>
              </th>
              <th className="text-left px-4 py-3 text-gray-700 font-bold">
                <div className="flex items-center gap-1">Order Quantity <span className="text-gray-400 text-xs">⇅</span></div>
              </th>
              <th className="text-left px-4 py-3 text-gray-700 font-bold">
                <div className="flex items-center gap-1">Total Value <span className="text-gray-400 text-xs">⇅</span></div>
              </th>
            </tr>
          </thead>
          <tbody>
